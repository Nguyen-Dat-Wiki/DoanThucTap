      ...
      <table class="table table-striped b-t b-light">
        ...
        <tbody>
          ...
          <tr>
            ...
            <td><img src="public/uploads/product/{{$pro->product_image}}" height="120" width="120"></td>
            ...
            <td>
              ...
              <a onclick="return confirm('Bạn muốn Xóa chứ ?') "href="{{URL::to('/delete-product/'.$pro->product_id)}}" class="active styling-edit" ui-toggle-class="">
