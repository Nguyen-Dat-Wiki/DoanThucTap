        ...
        <tbody>
          ...
          <tr class="color_qty_{{$details->product_id}}">
            ...
            <td>
              ...
              <input type="number" hidden min="1" {{$order_status==2 ? 'disabled' : ''}} class="order_qty_{{$details->product_id}}" value="{{$details->product_sales_quantity}}" name="product_sales_quantity">
