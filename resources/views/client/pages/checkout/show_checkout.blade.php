				...
				<div class="bill-to">
					...
					<div class="col-md-6 form-style">
						<form method="POST">
							...
							<input type="number" name="shipping_phone" class="shipping_phone form-control" placeholder="Số điện thoại">
							<textarea name="shipping_notes" class="shipping_notes form-control" placeholder="Ghi chú đơn hàng của bạn (Không có không cần điền)" rows="5"></textarea>
