...
class ProductController extends Controller
{
 ...
 public function delete_product($product_id){
    ...
    return view('client.pages.sanpham.show_details')->with('category',$cate_product)->with('brand',$brand_product)->with('product_details',$details_product)->with('rating',$rating)->with('slider',$slider);
    }
    ...
    public function load_comment(Request $request){
        ...
        foreach($comment as $key => $comm){
            ...
            <div class="row style_comment">
                                        <div class="col-md-2">
                                            <img width="100%" src="'.url('/public/frontend/images/customer_comment.jpg').'" class="img img-responsive img-thumbnail">
                                        </div>
                                        <div class="col-md-10">
                                    ...
                                    foreach($comment_rep as $key => $rep_comment)  {
                                     ...
                                     $output.= ' <div class="row style_comment" style="margin:5px 40px;background: aquamarine;">
                                        ...
                                        <div class="col-md-2">
                                            <img width="80%" src="'.url('/public/frontend/images/unknow.jpg').'" class="img img-responsive img-thumbnail">
                                        </div>
                                        <div class="col-md-10">
    ...
    public function reply_comment(Request $request){
        ...
        $comment->comment_name = 'Shop bán điện thoại';
        $comment->save();
